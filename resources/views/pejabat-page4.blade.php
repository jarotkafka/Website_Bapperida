...
<body class="font-sans antialiased bg-gray-50">
  ...
  <div class="container mx-auto px-4 py-8">
      ...
      <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div id="pejabat-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="p-5">
                ...
                <h3 class="text-lg font-bold text-gray-800 leading-tight">Dwi Udayani Retnaningtyas, S.Hut.</h3>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-gray-700">NIP: <span class="font-medium">197511132010012001</span></span>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
                    <span class="text-gray-700">S.Hut.</span>
                </div>
                </div>
            </div>
            </div>

            <!-- Pejabat 29: Eko Setyo Utomo -->
            <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
                data-nama="eko setyo">
            <div class="p-5">
                <div class="flex flex-col items-center text-center mb-4">
                ...
                <h3 class="text-lg font-bold text-gray-800 leading-tight">Eko Setyo Utomo, S.Sos., M.Si</h3>
                <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <i class="fas fa-id-card text-blue-500 text-xs"></i>
                    <span class="text-gray-700">NIP: <span class="font-medium">198312092006041002</span></span>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
                    <span class="text-gray-700">S.Sos., M.Si</span>
                </div>
                </div>
            </div>
            </div>

            <!-- Pejabat 30: Bayu Wijoseno -->
            <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
                data-nama="bayu wijoseno">
            <div class="p-5">
                <div class="flex flex-col items-center text-center mb-4">
                <div class="relative mb-3">
                    <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
                    <img src="{{ asset('image/bayu.jpg') }}"
                        alt="Bayu Wijoseno"
                        class="w-full h-full object-cover">
                    </div>
                    <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                ...
                <h3 class="text-lg font-bold text-gray-800 leading-tight">Bayu Wijoseno, S.Kom.</h3>
                <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <i class="fas fa-id-card text-blue-500 text-xs"></i>
                    <span class="text-gray-700">NIP: <span class="font-medium">198704042011011001</span></span>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
                    <span class="text-gray-700">S.Kom.</span>
                </div>
                </div>
            </div>
            </div>

            <!-- Pejabat 31: Agus Munawar Diansyah -->
            <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
                data-nama="agus munawar">
            <div class="p-5">
                <div class="flex flex-col items-center text-center mb-4">
                <div class="relative mb-3">
                    <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
                    <img src="{{ asset('image/agus.jpg') }}"
                        alt="Agus Munawar Diansyah"
                        class="w-full h-full object-cover">
                    </div>
                    <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                    <span class="bg-teal-400 text-white px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
                        Perencana Pertama
                    </span>
                    </div>
                </div>
                <h3 class="text-lg font-bold text-gray-800 leading-tight">Agus Munawar Diansyah, S.E</h3>
                <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Pertama</p>
                </div>

                <div class="space-y-2 text-sm">
                <div class="flex items-center gap-2">
                    <i class="fas fa-id-card text-blue-500 text-xs"></i>
                    <span class="text-gray-700">NIP: <span class="font-medium">198009042009011002</span></span>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            ...
            <!-- Pejabat 32: Ridwan Adithiansyah -->
            <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
                data-nama="ridwan adithiansyah">
            <div class="p-5">
                <div class="flex flex-col items-center text-center mb-4">
                <div class="relative mb-3">
                    <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
                    <img src="{{ asset('image/ridwan.jpg') }}"
                        alt="Ridwan Adithiansyah"
                        class="w-full h-full object-cover">
                    </div>
                    <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                    <span class="bg-teal-400 text-white px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
                ...
                <h3 class="text-lg font-bold text-gray-800 leading-tight">Ridwan Adithiansyah, S.T.</h3>
                <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Pertama</p>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <i class="fas fa-id-card text-blue-500 text-xs"></i>
                    <span class="text-gray-700">NIP: <span class="font-medium">199310212019031002</span></span>
                </div>
                <div class="flex items-center gap-2">
                    <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
    ...
    <div class="flex justify-center items-center gap-2 mb-12">
      ...
      <a href="{{ route('pejabat-page4') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium">4</a>
    </div>
