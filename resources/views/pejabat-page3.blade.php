    ...
    <div class="container mx-auto px-4 py-4">
      <nav class="flex text-sm">
        ...
        <span class="text-blue-600 font-medium">
          <i class="fas fa-user-tie mr-2"></i>Pejabat Bapperida - Halaman 3
        </span>
      </nav>
    </div>
  </div>
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="p-5">
        ...
        <div class="relative mb-3">
            ...
            <img src="{{ asset('image/sumaryanto.jpg') }}"
                alt="Sumaryanto"
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Sumaryanto, S.Pd., M.Si.</h3>
        ...
        <div class="flex items-center gap-2">
            ...
            <span class="text-gray-700">NIP: <span class="font-medium">197509242005011007</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            <span class="text-gray-700">S.Pd., M.Si.</span>
        </div>
        </div>
    </div>
    </div>

    <!-- Pejabat 20: Odih Sumirat -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
    ...
    <div class="p-5">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Odih Sumirat, S.E., M.M.</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">196906132007011012</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
    ...
    <div class="p-5">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Azhar Ginandjar, A.S., S.T., S.Sos., M.M</h3>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">197007092005011018</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            <span class="text-gray-700">A.S., S.T., S.Sos., M.M</span>
        </div>
        </div>
    </div>
    </div>

    <!-- Pejabat 22: Ratu Desy Savitri -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
        data-nama="ratu desy">
    <div class="p-5">
        <div class="flex flex-col items-center text-center mb-4">
        <div class="relative mb-3">
            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
            <img src="{{ asset('image/ratudesy.jpg') }}"
                alt="Ratu Desy Savitri"
                class="w-full h-full object-cover">
            </div>
            <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
            <span class="bg-teal-500 text-white px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Ratu Desy Savitri, S.T., M.T</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">196912142002122001</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
    ...
    <!-- Pejabat 23: Yeyen Esva Respati -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
        data-nama="yeyen esva">
    <div class="p-5">
        <div class="flex flex-col items-center text-center mb-4">
        <div class="relative mb-3">
            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
            <img src="{{ asset('image/yeyen.jpg') }}"
                alt="Yeyen Esva Respati"
                class="w-full h-full object-cover">
            </div>
            <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
            <span class="bg-teal-500 text-white px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Yeyen Esva Respati, S.E., M.Ec.Dev.</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">198202252006042015</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            <span class="text-gray-700">S.E., M.Ec.Dev.</span>
        </div>
        </div>
    </div>
    </div>

    <!-- Pejabat 24: Erni Solikhati -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
        data-nama="erni solikhati">
    <div class="p-5">
        <div class="flex flex-col items-center text-center mb-4">
        <div class="relative mb-3">
            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
            <img src="{{ asset('image/erni.jpg') }}"
                alt="Erni Solikhati"
                class="w-full h-full object-cover">
            </div>
            <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Erni Solikhati, S.E</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">197212161994032005</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
    ...
    <!-- Pejabat 25: Abdul Haris -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
        data-nama="abdul haris">
    <div class="p-5">
        <div class="flex flex-col items-center text-center mb-4">
        <div class="relative mb-3">
            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
            <img src="{{ asset('image/abdul.jpg') }}"
                alt="Abdul Haris"
                class="w-full h-full object-cover">
            </div>
            <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Abdul Haris, S.T.</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">197810022009021001</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            <span class="text-gray-700">S.T.</span>
        </div>
        </div>
    </div>
    </div>

    <!-- Pejabat 26: Dadang Komarudin -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
        data-nama="dadang komarudin">
    <div class="p-5">
        <div class="flex flex-col items-center text-center mb-4">
        <div class="relative mb-3">
            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
            <img src="{{ asset('image/dadang.jpg') }}"
                alt="Dadang Komarudin"
                class="w-full h-full object-cover">
            </div>
            <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
            <span class="bg-teal-500 text-white px-2 py-1 rounded-full text-xs font-semibold whitespace-nowrap">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Dadang Komarudin, S.E., M.M.</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">197404161999011001</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            <span class="text-gray-700">S.E., M.M.</span>
    ...
    <!-- Pejabat 27: Ati Fatimah -->
    <div class="pejabat-card bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
        data-nama="ati fatimah">
    <div class="p-5">
        <div class="flex flex-col items-center text-center mb-4">
        <div class="relative mb-3">
            <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-blue-100 mx-auto">
            <img src="{{ asset('image/ati.jpg') }}"
                alt="Ati Fatimah"
                class="w-full h-full object-cover">
            </div>
            <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
        ...
        <h3 class="text-lg font-bold text-gray-800 leading-tight">Ati Fatimah, S.IP.</h3>
        <p class="text-blue-600 font-medium text-sm mt-1">Perencana Ahli Muda</p>
        </div>
        ...
        <div class="flex items-center gap-2">
            <i class="fas fa-id-card text-blue-500 text-xs"></i>
            <span class="text-gray-700">NIP: <span class="font-medium">198308302002122001</span></span>
        </div>
        <div class="flex items-center gap-2">
            <i class="fas fa-graduation-cap text-blue-500 text-xs"></i>
            <span class="text-gray-700">S.IP.</span>
        </div>
        </div>
    </div>
    </div>
    ...
    <div class="flex justify-center items-center gap-2 mb-12">
      ...
      <a href="{{ route('pejabat-page2') }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50">2</a>
      <a href="{{ route('pejabat-page3') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium">3</a>
