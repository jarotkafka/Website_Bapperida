...
<head>
    ...
    overflow: hidden;
        ...
        /* Styled select matching the search input */
        .search-select {
            appearance: none;
...
<body class="font-sans antialiased bg-gray-50">
        ...
        <div class="relative z-10 container mx-auto px-4 py-24">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                    Dokumentasi dan arsip dokumen penelitian dan pengembangan
                </p>
            </div>
        </div>
    </section>
    ...
    <div class="search-wrapper">
        <div class="search-box">
            ...
            <select id="categorySelect" class="search-select">
                ...
                <option value="Daftar Informasi">Pilih Sub Kategori</option>
            </select>
    ...
    <div class="dokumen-container">
        ...
        <div class="dokumen-grid">
            <div class="dokumen-card" data-title="Laporan Akhir Kajian Kontribusi Ekonomi Kreatif dan UMKM Terhadap PDRB Kota Bogor" data-category="Litbang">
                <div class="dokumen-card-header">
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Rabu, 14 Januari 2026</div>
                        </div>
                        <div class="dokumen-judul">Laporan Akhir Kajian Kontribusi Ekonomi Kreatif dan UMKM Terhadap PDRB Kota Bogor</div>
                    </div>
                </div>
            ...
            <!-- Dokumen Item 2 -->
            <div class="dokumen-card" data-title="Laporan Bogor Innovation Award (BIA) Tahun 2025" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Senin, 15 Desember 2025</div>
                        </div>
                        <div class="dokumen-judul">Laporan Bogor Innovation Award (BIA) Tahun 2025</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 3 -->
            <div class="dokumen-card" data-title="Laporan Akhir Strategi Kebijakan Akses Permodalan Usaha Mikro di Kota Bogor 2025" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Kamis, 20 November 2025</div>
                        </div>
                        <div class="dokumen-judul">Laporan Akhir Strategi Kebijakan Akses Permodalan Usaha Mikro di Kota Bogor 2025</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 4 -->
            <div class="dokumen-card" data-title="Laporan Akhir Strategis Kebijakan Optimalisasi Pendapatan Asli Daerah Kota Bogor 2025" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Sabtu, 25 Oktober 2025</div>
                        </div>
                        <div class="dokumen-judul">Laporan Akhir Strategis Kebijakan Optimalisasi Pendapatan Asli Daerah Kota Bogor 2025</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 5 -->
            <div class="dokumen-card" data-title="Laporan Akhir Kajian Kebahagiaan Anak Muda/Remaja Kota Bogor" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Jumat, 06 Desember 2024</div>
                        </div>
                        <div class="dokumen-judul">Laporan Akhir Kajian Kebahagiaan Anak Muda/Remaja Kota Bogor</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 6 -->
            <div class="dokumen-card" data-title="Laporan Akhir Kajian Peningkatan Pelayanan Publik Kota Bogor Berbasis IoT (Studi Kasus Layanan Transportasi Publik)" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Senin, 18 November 2024</div>
                        </div>
                        <div class="dokumen-judul">Laporan Akhir Kajian Peningkatan Pelayanan Publik Kota Bogor Berbasis IoT (Studi Kasus Layanan Transportasi Publik)</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 7 -->
            <div class="dokumen-card" data-title="Laporan Akhir Kajian Indeks Kebahagiaan Anak Muda/Remaja Kota Bogor" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        ...
                        <div class="dokumen-judul">Laporan Akhir Kajian Indeks Kebahagiaan Anak Muda/Remaja Kota Bogor</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 8 -->
            <div class="dokumen-card" data-title="Laporan Bogor Innovation Award (BIA) Tahun 2024" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        ...
                        <div class="dokumen-judul">Laporan Bogor Innovation Award (BIA) Tahun 2024</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 9 -->
            <div class="dokumen-card" data-title="Laporan Akhir Kajian Pemberdayaan Masyarakat Melalui Kampung Tematik" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        <div class="dokumen-meta">
                            <div class="dokumen-tanggal"><i class="fa-regular fa-calendar"></i> Kamis, 17 Oktober 2024</div>
                        </div>
                        <div class="dokumen-judul">Laporan Akhir Kajian Pemberdayaan Masyarakat Melalui Kampung Tematik</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
            ...
            <!-- Dokumen Item 10 -->
            <div class="dokumen-card" data-title="Laporan Akhir Kajian Agrowisata Berbasis Pertanian Organik di Kota Bogor" data-category="Litbang">
                <div class="dokumen-card-header">
                    <div class="dokumen-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    ...
                    <div class="dokumen-header-text">
                        ...
                        <div class="dokumen-judul">Laporan Akhir Kajian Agrowisata Berbasis Pertanian Organik di Kota Bogor</div>
                    </div>
                </div>
                <div class="dokumen-footer">
                    <a href="#" class="dokumen-button">
